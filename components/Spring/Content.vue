...
const setImgUrl = () => {
    try {
        ...
        const url = new URL(`../../assets/images/Spring/${clickedDay.value}.jpg`, import.meta.url);
        //refに画像のURLを返す
...
const preloadImages = async () => {
    ...
    for (let i = 0; i < totalImg; i++) {
        const img = new Image();
        // ファイルパスを正しく生成する
        const imgPath = `../../assets/images/Spring/day${i}.jpg`;
...
<template>
    ...
    <div class="petal">&#x273f;</div>
    <div class="petal petal2nd">&#x273f;</div>
</template>

<style>
.petal {
    /*雪の色*/
    color: rgb(255, 111, 168);
    /*雪の大きさ*/
    font-size: 10px;
    /*初期位置*/
    position: fixed;
